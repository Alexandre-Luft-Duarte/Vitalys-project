...
INSERT INTO atendimento (data_hora, status, paciente_id_pessoa, recepcionista_id_pessoa, departamento_id_departamento, profissional_id_pessoa)
VALUES ('2025-11-18 08:00:00', 'AGUARDANDO', 6, 1, 2, NULL);

-- Atendimento 2: Ana (7) está EM_ATENDIMENTO com a Dra. Grey (4) na Pediatria (3).
INSERT INTO atendimento (data_hora, status, paciente_id_pessoa, recepcionista_id_pessoa, departamento_id_departamento, profissional_id_pessoa)
VALUES ('2025-11-18 09:30:00', 'EM_ATENDIMENTO', 7, 2, 3, 4);

-- Atendimento 3: Pedro (8) teve o atendimento FINALIZADO com Dr. House (3) na Ortopedia (4).
INSERT INTO atendimento (data_hora, status, paciente_id_pessoa, recepcionista_id_pessoa, departamento_id_departamento, profissional_id_pessoa)
VALUES ('2025-11-17 14:00:00', 'FINALIZADO', 8, 1, 4, 3);

-- Atendimento 4: Julia (9) foi atendida por Shaun (5), FINALIZADO e gerou internação.
INSERT INTO atendimento (data_hora, status, paciente_id_pessoa, recepcionista_id_pessoa, departamento_id_departamento, profissional_id_pessoa)
VALUES ('2025-11-15 10:00:00', 'FINALIZADO', 9, 1, 5, 5);
