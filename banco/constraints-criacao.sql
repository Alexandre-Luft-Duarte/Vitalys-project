...
-- ========================================================
-- 2. CRIAÇÃO DAS TABELAS E CONSTRAINTS BÁSICAS
-- ========================================================

CREATE TABLE pessoa (
    id_pessoa bigint GENERATED BY DEFAULT AS IDENTITY,
    nome_completo varchar(255) NOT NULL,
    cpf varchar(14) NOT NULL UNIQUE, -- Ajustado para 14 chars e UNIQUE explícito
...
-- Herança/Extensão de Pessoa: Paciente
...
-- Herança/Extensão de Pessoa: Usuário
...
-- Herança/Extensão de Usuário: Profissional
...
-- Herança/Extensão de Usuário: Recepcionista
...
CREATE TABLE internacao (
    ...
    id_atendimento bigint NOT NULL UNIQUE, -- 1 Atendimento gera max 1 internação
    ...
    -- Restrição Lógica: Data de saída não pode ser menor que entrada
...
-- ========================================================
-- 3. CRIAÇÃO DE ÍNDICES (PERFORMANCE)
-- ========================================================
-- Índices em colunas muito utilizadas em WHERE ou JOIN

-- Índices para Pessoa
CREATE INDEX idx_pessoa_nome ON pessoa(nome_completo);
CREATE INDEX idx_pessoa_cpf ON pessoa(cpf);

-- Índices para Atendimento (Consultas por data e chaves estrangeiras)
...
-- Índices para Internação
CREATE INDEX idx_internacao_paciente ON internacao(id_paciente);
CREATE INDEX idx_internacao_status ON internacao(status);

-- ========================================================
-- 4. CRIAÇÃO DE VIEWS (RELATÓRIOS E VISUALIZAÇÃO)
-- ========================================================

-- VIEW 1: Detalhes completos do Paciente (Juntando Pessoa, Contato e Endereço)
...
-- VIEW 2: Agenda de Atendimentos (Humanizando os IDs)
