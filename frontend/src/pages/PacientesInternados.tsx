...
import { ArrowLeft, Bed, Calendar, User, Users } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { useToast } from "@/hooks/use-toast";
import { useEffect, useState } from "react";
import { formatDate } from "@/lib/utils";
import EvolucaoInternacaoModal from "@/components/EvolucaoInternacaoModal";
            ...
            <main className="container mx-auto px-6 py-8">
                <section className="mb-8">
                     <Button
                        ...
                        className="h-20 text-lg font-semibold bg-gradient-to-r from-primary to-accent hover:opacity-90 transition-opacity shadow-md w-full md:w-auto"
                    >
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="border-b border-border hover:bg-transparent">
                                    ...
                                    <TableHead className="font-semibold text-foreground">Data Internação</TableHead>
                                    <TableHead className="font-semibold text-foreground">Motivo</TableHead>
                                    <TableHead className="font-semibold text-foreground">Médico Responsável</TableHead>
                                ...
                                {internacoes.length === 0 ? (
                                    ...
                                    internacoes.map((internacao: any) => (
                                        <TableRow
                                            ...
                                            onClick={() => handlePacienteClick(internacao)}
                                        >
